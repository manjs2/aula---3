...
setwd("/Users/amandabarreto/Desktop/Econometria")
library("readr")                               #Carrega o pacote de leitura de arquivos .csv
br <- read.csv("/Users/amandabarreto/Desktop/Econometria/aula 3/br.csv")      #Lê o arquivo br.csv de acordo com o caminho especificado
